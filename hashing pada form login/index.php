...
<br><div class="small"><a href="registrasi.php">Registrasi? </a></div>		
...
if (isset($_POST['blogin'])) {
	...
	$sql="select * from pengguna where kodelogin = '".$hashkodelogin."' and password='".$hashpswd."'";
  ...
  if(!isset($_SESSION))session_start();
    ...
    echo "<script>window.location.href='mata kuliah.php';</script>";
  }
}
